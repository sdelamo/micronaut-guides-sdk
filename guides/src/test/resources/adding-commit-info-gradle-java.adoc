...
----
include::{sourceDir}/adding-commit-info-gradle-java/src/main/resources/application.yml[tag=endpoints]
...
----
include::{sourceDir}/adding-commit-info-gradle-java/src/test/java/example/micronaut/InfoTest.java[lines=16..-1]
----
...
----
include::{sourceDir}/adding-commit-info-gradle-java/src/main/java/example/micronaut/Application.java[lines=16..-1]
----
...
----
include::{sourceDir}/adding-commit-info-gradle-java/src/main/resources/META-INF/native-image/resource-config.json[]
----

...
<1> https://micronaut-projects.github.io/micronaut-data/3.0.1/api/io/micronaut/data/jdbc/annotation/JdbcRepository.html[`@JdbcRepository`] with a specific dialect.
